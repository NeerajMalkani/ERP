...
import { RawMaterialsData } from "../../../json/listitems";
...
const RawMaterialScreen = ({ navigation }) => {
  ...
  const AddCallback = () => {
    navigationRef.navigate("AddRawMaterial", { clickHandler: UpdateList, currentList: listData[0] });
  };
